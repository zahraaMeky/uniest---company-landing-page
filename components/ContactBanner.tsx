...
const ContactBanner = () => {
  return (
    <div className='w-full min-h-screen bg-[url("/contactBG.svg")] bg-cover bg-center sm:bg-right bg-no-repeat flex flex-col gap-5 sm:gap-6 lg:gap-6 px-6 sm:px-12 lg:px-20'>
    ...
    <div className='max-w-md sm:max-w-sm text-left'>
      <p className="text-[#585858] text-base sm:text-lg">
